const CONFIG = {
    ...
    PRESTIGE_PERKS: [
        {
            id: "p1",
            name: "Генетическая База",
            desc: "+35% ко всей добываемой Мотивации за уровень",
            cost: 1,
            costGrowth: 1.35,
            level: 0,
            max: 15
        ...
        {
            id: "p2",
            name: "Благородный Старт",
            desc: "Каждый уровень повышает стартовую пару мыслей: T2 → T3 → T4",
            cost: 3,
            costGrowth: 2.0,
            level: 0,
            max: 3
        ...
        {
            id: "p3",
            name: "Титановые Легкие",
            desc: "+100 к максимальной Дыхалке за каждый уровень",
            cost: 2,
            costGrowth: 1.7,
            level: 0,
            max: 5
        },
        {
            id: "p4",
            name: "Оффлайн-Магнат",
            desc: "Увеличивает лимит и эффективность оффлайн-дохода",
            cost: 3,
            costGrowth: 1.75,
            level: 0,
            max: 4
        },
        {
            id: "p5",
            name: "Авто-Мыслитель",
            desc: "Включает аккуратный авто-сброс мыслей",
            cost: 10,
            costGrowth: 1,
            level: 0,
            max: 1
        ...
        {
            id: "p6",
            name: "Квантовый Череп",
            desc: "Стакан навсегда на +25px шире за уровень",
            cost: 4,
            costGrowth: 1.9,
            level: 0,
            max: 3
        },
        {
            id: "p7",
            name: "Охотник на Боссов",
            desc: "+50% урона по боссам от всех источников за уровень",
            cost: 3,
            costGrowth: 1.8,
            level: 0,
            max: 5
        ...
        {
            id: "p8",
            name: "Золотой Конвейер",
            desc: "+25% к шансу бесплатных расходников и фриспинов за уровень",
            cost: 4,
            costGrowth: 1.8,
            level: 0,
            max: 4
